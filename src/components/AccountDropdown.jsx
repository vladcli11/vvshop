...
export default function AccountDropdown({ onClose }) {
  return createPortal(
    <div className="fixed inset-0 z-[9998] flex items-center justify-center bg-black/50 animate-fade-in">
      <div className="relative bg-white/90 backdrop-blur-xl border border-green-100 rounded-2xl shadow-2xl w-11/12 max-w-sm p-8 flex flex-col items-center gap-4 animate-fade-in-up">
        <button
          onClick={onClose}
