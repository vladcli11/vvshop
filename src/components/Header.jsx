    ...
    <div className="relative h-[64px] mb-4 w-full max-w-6xl mx-auto">
      ...
      <button
        ...
        className={`absolute top-3 right-1 ${
          currentUser ? "bg-orange-500" : "bg-white"
      ...
      {currentUser && showDropdown && (
        <div
          ref={dropdownRef}
          className="absolute top-16 right-1 bg-white border border-gray-300 rounded-lg shadow-lg p-2 z-20 text-sm w-24 h-12"
        >
          <button
            onClick={() => {
              signOut(auth);
            ...
            className="w-full text-centered px-3 py-2 hover:bg-gray-100 rounded"
          >
            Logout
          </button>
        </div>
